  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div>
                ...
                {editing ? (
                  <input
                    ...
                    className="w-full rounded-lg border border-border bg-background px-3 py-2 text-foreground focus:outline-hidden focus:ring-2 focus:ring-primary/50"
                  />
                ) : (
        ...
        {/* Export Health Data — patients only */}
        {user?.role === "patient" && (
          <Card className="mt-6">
            <CardHeader>
              <CardTitle>Health Data Export</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Download a copy of your health records as a PDF report or CSV spreadsheet.
              </p>
